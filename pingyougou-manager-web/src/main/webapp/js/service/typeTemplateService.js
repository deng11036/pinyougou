...
app.service('typeTemplateService',function($http){
	...
	this.findTempList=function (id) {
		return $http.get('../typeTemplate/findTempList.do?id='+id);
	}

	this.findTempListOne=function (typeId) {
		return $http.get('../typeTemplate/findTempListOne.do?typeId='+typeId)
	}
